...
You should thus define logical/business keys to your graph entities in the form of link:https://neo4j.com/docs/cypher-manual/current/schema/constraints/create-constraints/#create-key-constraints[node and relationship _key constraints_].
