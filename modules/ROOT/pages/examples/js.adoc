...
See xref:examples/index.adoc#monitoring-and-address-cdc-client-performance[High-volume change processing] for throughput guidance when extending this example.
