...
See xref:examples/index.adoc#monitoring-and-address-cdc-client-performance[Monitoring and addressing CDC client performance] for throughput guidance when extending this example.
