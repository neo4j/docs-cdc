...
Because transaction `2254` is contained within `neo4j-2025-04-18T06-59-12.backup`, which also contains other unprocessed transactions`, it is safe to aggregate up until the file before.
