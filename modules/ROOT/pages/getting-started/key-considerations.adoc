...
This database has a new transaction log and any changeID (cursor) generated from the old transaction log will not be usable with the new database.
...
If the node/relationship is updated, your CDC application will se an update to a previously deleted entity.
