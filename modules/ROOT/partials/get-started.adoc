...
- `FULL` -- Changes are recorded as a complete copy of the before and after states of each changed entity (i.e. they contain the full node/relationship, regardless of the extent to which they were altered).
